        ...
        <div className="grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:gap-24">
          ...
          <div>
                ...
                {wedding.timeline.map((event, index) => {
                  ...
                  return (
                    <motion.article
                      ...
                      className="relative grid grid-cols-[2.75rem_1fr] gap-5 sm:grid-cols-[3.25rem_1fr] sm:gap-7"
                    >
                      ...
                      <div className="border-t border-line pt-1 sm:pt-2">
                        <h3 className="font-heading text-3xl leading-none text-charcoal sm:text-5xl">{event.title}</h3>
            ...
            <motion.div
              ...
              className="mt-10 border-t border-line pt-5 sm:mt-12 sm:pt-6"
            >
