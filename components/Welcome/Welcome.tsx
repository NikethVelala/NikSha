        ...
        <Invitation3D>
          <div className="relative overflow-hidden border-[1.5px] border-[#a8783f]/65 bg-[#fcfaf4] px-6 py-8 shadow-[0_16px_55px_rgba(73,55,35,0.11)] sm:px-12 sm:py-11">
            ...
            <div className="relative text-center">
              <p className="font-heading text-xl tracking-wide text-[#8c6130] sm:text-2xl">శ్రీ</p><p className="mt-1 font-heading text-xs tracking-[0.18em] text-[#8c6130] sm:text-sm">శుభమస్తు</p><p className="mx-auto mt-4 max-w-sm text-[10px] uppercase leading-5 tracking-[0.24em] text-[#756957] sm:text-[10px] sm:tracking-[0.4em]">With the blessings of our parents &amp; elders</p>
              <div className="mt-5 flex justify-center sm:mt-6"><CardOrnament /></div><p className="mt-5 text-[10px] uppercase tracking-[0.28em] text-[#93673b] sm:text-[9px]">The Wedding Invitation</p>
              ...
              <div><p className="text-[10px] uppercase tracking-[0.3em] text-[#756957] sm:text-[9px]">Wednesday</p><p className="mt-1.5 font-heading text-3xl text-[#292622] sm:text-5xl">18 November 2026</p></div>
