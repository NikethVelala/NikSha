...
export default function Welcome() {
  ...
  useEffect(() => {
    ...
    html.style.overflow = "auto"; body.style.overflow = "auto"; html.style.touchAction = "auto"; body.style.touchAction = "auto"; html.style.overscrollBehavior = "none"; body.style.overscrollBehavior = "none";
    ...
    window.addEventListener("scroll", armGate, { passive: true }); window.addEventListener("resize", clampToInvitation);
