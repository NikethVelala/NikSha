...
function CardOrnament({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 32" aria-hidden="true" className={`h-8 w-28 text-[#a8783f] ${className}`} fill="none">
      <path d="M2 16h30M88 16h30" stroke="currentColor" strokeWidth=".8" />
      <path d="M60 4c-5 6-5 18 0 24M60 4c5 6 5 18 0 24M48 16c5-5 19-5 24 0M48 16c5 5 19 5 24 0" stroke="currentColor" strokeWidth=".8" />
      <path d="M54 10c-2 2-2 10 0 12M66 10c2 2 2 10 0 12" stroke="currentColor" strokeWidth=".6" />
      <circle cx="60" cy="16" r="2.5" stroke="currentColor" strokeWidth=".8" />
    </svg>
  );
}
...
function CornerFlourish({ position }: { position: "tl" | "tr" | "bl" | "br" }) {
  ...
  return (
    ...
    >
      ...
      <path d="M8 8h35c21 0 39 18 39 39v35" stroke="currentColor" strokeWidth=".55" />
      <path d="M18 8c0 14 7 22 20 25M8 18c14 0 22 7 25 20" stroke="currentColor" strokeWidth=".7" />
      <path d="M31 10c7 5 10 11 10 19M10 31c5 7 11 10 19 10" stroke="currentColor" strokeWidth=".55" />
      <circle cx="43" cy="43" r="2" fill="currentColor" />
    </svg>
  );
}
...
export default function Welcome() {
  ...
  return (
    <Section
      id="welcome"
      className="relative overflow-hidden bg-[#f5eee2] py-10 sm:py-16"
    >
      ...
      >
        <div className="relative overflow-hidden border-[1.5px] border-[#a8783f]/65 bg-[#fcfaf4] px-6 py-8 shadow-[0_16px_55px_rgba(73,55,35,0.11)] sm:px-12 sm:py-11">
          ...
          <div className="relative text-center">
            ...
            <div className="mt-5 flex justify-center sm:mt-6"><CardOrnament /></div>
            ...
            <div className="my-6 flex items-center justify-center gap-3 sm:my-7">
              <span className="h-px w-10 bg-[#a8783f]/40 sm:w-16" /><span className="text-[8px] text-[#a8783f]">✦</span><span className="h-px w-10 bg-[#a8783f]/40 sm:w-16" />
            </div>
            ...
            <div className="mt-6">
              ...
              <a href={wedding.ceremony.venue.maps} target="_blank" rel="noreferrer" className="mt-4 inline-flex min-h-10 items-center gap-2 border border-[#8c6130] bg-[#8c6130] px-5 py-2 text-[8px] font-medium uppercase tracking-[0.23em] text-white transition-colors hover:bg-[#714b24] sm:mt-5 sm:px-6 sm:text-[9px]">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-20px" }} transition={{ duration: 0.8, delay: 0.15 }} className="px-3 pb-14 pt-8 text-center sm:pb-16 sm:pt-10">
          <p className="text-[8px] font-medium uppercase tracking-[0.32em] text-[#756957] sm:text-[9px]">There&apos;s more to our story</p>
          <p className="mt-1 font-heading text-lg italic text-[#5e554c] sm:text-2xl">If you&apos;d like to stay a little longer…</p>
          <a href="#story" onClick={(event) => { event.preventDefault(); openStory(); }} className="group mx-auto mt-5 flex min-h-14 w-full max-w-sm items-center justify-center gap-3 rounded-full border-2 border-[#b58a52] bg-[#174f3b] px-6 py-4 text-[10px] font-medium uppercase tracking-[0.24em] text-[#fbf5e8] shadow-[0_10px_28px_rgba(23,79,59,0.18)] transition-all hover:-translate-y-0.5 hover:bg-[#123f30] active:translate-y-0 sm:mt-6 sm:min-h-16 sm:max-w-md sm:text-xs sm:tracking-[0.28em]">
            Discover Our Story
